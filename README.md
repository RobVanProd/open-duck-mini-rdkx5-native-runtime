...
| Hardware gates 1-5 | `PASS_REVIEWED`: Gates 1-4 plus both suspended T247 Gate 5 arms (x=0 and x=.08) completed with timing, bus, policy, operator, and torque-off evidence green |
