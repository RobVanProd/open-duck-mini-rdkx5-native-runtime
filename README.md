...
| Hardware gates 1-5 | Gate 1 `PASS_REVIEWED`; Gate 2 `NOT_RUN_BLOCKED_PREFLIGHT` after a frozen 10,000-tick USB sweep failed the `<5 ms` bus gate; Gates 3-5 `NOT_RUN` |
