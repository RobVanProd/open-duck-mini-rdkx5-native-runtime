...
| Winner-v2 runtime-v2 | Separate/default-disabled 115-D implementation passes all 2,400 offline ticks; Windows and independent Linux CPU reviews agree on bit-exact STS wire closure, and the external policy/P30/reference/config/runtime identities are frozen; physical COM, policy clearance, and no-servo X5 CPU replay remain |
