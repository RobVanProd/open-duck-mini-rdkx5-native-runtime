...
| Hardware gates 1-5 | Gate 1 `PASS_REVIEWED`; Gate 2 moving hold remains `NOT_RUN`; a source/config-frozen performance-governor launcher is offline-tested and awaits fresh authorization; Gates 3-5 `NOT_RUN` |
