...
| 5. Policy host | Implemented, contract- and evidence-tested | `NOT_RUN` | Golden observation vector and warm-up pass |
| 6. Ops/safety | Implemented, cutoff-first and unit-tested | explicit `NOT_RUN` artifact | Physical cutoff latency, crash/watchdog torque-off, and pause verified |
| 7. Hardware gates | Five separate artifacts pre-registered | all five `NOT_RUN` | Each gate separately authorized and passed |
