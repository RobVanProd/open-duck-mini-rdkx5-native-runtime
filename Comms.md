...
Status: `T247_OFFLINE_GREEN - X5_THREAD_CPU_ATTRIBUTION_PACKAGE_SEALED - GATE_5_BLOCKED`
...
Local validation at this handoff is green: `492` tests pass and the `211`-entry
