...
| BNO055 + contacts | transactional guarded `calibrate_imu`; nonblocking immutable publication; guarded labeled `probe_sensors`; chip-ID and exact calibration readback; nine-label review validator | capture authorization/timeout/atomicity/schema/readback tests; restricted conversion, raw-unit, axis-remap, polarity, freshness, blocked-I2C, provenance, tamper, and guard tests | BNO identity and BCM22→GPIO388 / BCM27→GPIO379 input claims verified; physical calibration and labeled review `NOT_RUN` |
