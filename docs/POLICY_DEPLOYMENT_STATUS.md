...
matrix, the former upper-Z blocker, and the first five conditions of a fresh
...
| T237 sequential full R2 | `5/20 conditions; 80/80 completed cells green` |
...
T237 progress SHA-256 after condition 5:
`cdc71a35699ecc93623e57577cb0e66939a9a16751817365d4b52f25d3d84499`

Completed conditions:

1. floor friction `0.5`;
2. floor friction `1.0`;
3. joint friction loss `0.9×`;
4. joint friction loss `1.1×`; and
5. armature scale `1.0×`.

Each condition contains both checkpoints, both measured actuator fits, and all
four commands. All 80 completed cells passed duration, gait, tracking, rate,
